...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Navn:</b></td><td>' . htmlentities($_REQUEST["custom_U326"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Beskriv Opgaven og dens omfang:</b></td><td>' . htmlentities($_REQUEST["custom_U342"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Telefonnummer:</b></td><td>' . htmlentities($_REQUEST["custom_U347"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Virksomhed (hvis aktuelt):</b></td><td>' . htmlentities($_REQUEST["custom_U315"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Andet:</b></td><td>' . htmlentities($_REQUEST["custom_U320"],ENT_COMPAT,'UTF-8') . '</td></tr>';
