...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Navn:</b></td><td>' . htmlentities($_REQUEST["custom_U185"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Beskriv Opgaven og dens omfang:</b></td><td>' . htmlentities($_REQUEST["custom_U174"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Telefonnummer:</b></td><td>' . htmlentities($_REQUEST["custom_U194"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Virksomhed (hvis aktuelt):</b></td><td>' . htmlentities($_REQUEST["custom_U200"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Andet:</b></td><td>' . htmlentities($_REQUEST["custom_U205"],ENT_COMPAT,'UTF-8') . '</td></tr>';
